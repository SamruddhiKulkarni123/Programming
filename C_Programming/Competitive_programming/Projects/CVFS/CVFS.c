...
void DisplayHelp()
{
    ...
    printf("exit : It is used to terminate the Marvellous CVFS\n");
...
//  Description :       It is used to Display manpage of  
//                      specific command
...
void ManPageDisplay(char Name[])
{
    ...
    {
        printf("About : It is used to creat the new file\n");
        printf("Usage : creat File_name Permission \n");
        printf("File_name : name of file that we want to creat\n");
    ...
    {
        printf("About : It is used to open the existing regular file\n");
        printf("Usage : open File_name Permission\n");
        printf("File_name : name of file that we want to open\n");
        printf("Permission : permission to open the file with\n");
        printf("Permission : Read -> 1\n");
        printf("Permission : Write -> 2\n");
        printf("Permission : Read + Write -> 3\n");
    }
    else if(strcmp(Name,"close") == 0)
    {
        ...
        printf("File_Descriptor : fd of file that we want to close\n");
    }
    else if(strcmp(Name,"read") == 0)
    {
        printf("About : It is used to read data from a file\n");
        printf("Usage : read File_Descriptor Size\n");
        printf("File_Descriptor : fd of file that we want to read from\n");
        printf("Size : number of bytes to read\n");
    }
    else if(strcmp(Name,"write") == 0)
    {
        printf("About : It is used to write data into a file\n");
        printf("Usage : write File_Descriptor\n");
        printf("File_Descriptor : fd of file that we want to write into\n");
    }
    else if(strcmp(Name,"man") == 0)
    {
        printf("About : It is used to display manual page of a command\n");
        printf("Usage : man Command_name\n");
        printf("Command_name : name of command whose manual should be shown\n");
    }
    else
    {
...
//  Description :       It is used to create new  
//                      file
...
//  Description :       It is used to take
//                      backup of all files that are on RAM
    ...
    while(1)
    {
        ...
        if(iCount == 1)
        {
            ...
            if(strcmp(Command[0],"exit") == 0)
            {
                ...
                printf("Deallocating all resourcse of Marvellous CVFS\n");
        ...
        {
            //Marvellous CVFS : >man open(name of method like open ,read ,write, exit ,etc)
        ...
        else if(iCount == 3)
        {
            ...
            else if(strcmp(Command[0],"read") == 0)
            {
                ...
                if(iRet == ERR_INVALID_PARAMETER)
                {
                    printf("Error : Invalid parmeters\n");
                }
                else if(iRet == ERR_FILE_NOT_EXIST)
                {
